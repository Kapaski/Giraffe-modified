...
//        "{{#gauges}}\n  "+
        ...
        "<p><b>{{metric_alias}} <span class=\"pull-right graph-summary\"><span></b></p>\n  " +
    ...
    onComplete: function(transport) {
      ...
      yAxis = new Rickshaw.Graph.Axis.Y({
        ...
        tickFormat: function(y) {
          return _formatBase1024KMGTP(y*1024*1024);
        },
        ticksTreatment: 'glow'
      });
      yAxis.render();
      ...
      detail = new Rickshaw.Graph.HoverDetail({
        ...
        yFormatter: function(y) {
          return hover_formatter(y*1024*1024);
        }
      });
      $("" + anchor + " .legend").empty();
...
Rickshaw.Graph.JSONP.Graphite = Rickshaw.Class.create(Rickshaw.Graph.JSONP, {
  ...
  addTotals: function(i) {
    ...
    sum = _formatBase1024KMGTP(_sum(series_data)*1024*1024);
    max = _formatBase1024KMGTP(_max(series_data)*1024*1024);
    min = _formatBase1024KMGTP(_min(series_data)*1024*1024);
    avg = _formatBase1024KMGTP(_avg(series_data)*1024*1024);
